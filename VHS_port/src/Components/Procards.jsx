...
function Procards({ project, reverse = false }) {
    ...
    return (
        <article
            className="
                group relative flex min-h-[560px] w-full items-center justify-center
        ...
        >
            ...
            <img
                ...
                className={`
                    ...
                    ${reverse ? "left-10 scale-x-[-1]" : "right-10"}
                `}
            />
            ...
            >
                ...
                <div
                    className={`
                        ...
                        ${reverse ? "left-5 max-sm:left-4" : "right-5 max-sm:right-4"}
                    `}
                >
                    <button
                        onClick={prevSlide}
                ...
                {/* Dots */}
                <div className="absolute bottom-6 left-1/2 flex -translate-x-1/2 gap-1.5 max-sm:bottom-5">
                    {project.images.map((image, index) => (
                        <button
                            key={image}
